<x-base-layout>
    ...
    <div class="max-w-[85rem] px-4 pt-10 sm:px-6 lg:px-8 mx-auto">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Nacionalidades Disponíveis</h1>
    </div>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                  ...
                  <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-neutral-800">
                      <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-neutral-600">
                        {{ $nacionalidade->id }}
                      </td>
                      <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-neutral-600">
                        {{ $nacionalidade->name }}
                    ...
                    <a href="{{ route('detalhes-nacionalidade', $nacionalidade) }}" class="text-blue-600 hover:text-blue-700 dark:text-blue-500 dark:hover:text-blue-400">Ver Detalhes</a>
                    </td>
                    </tr>
                    @endforeach
